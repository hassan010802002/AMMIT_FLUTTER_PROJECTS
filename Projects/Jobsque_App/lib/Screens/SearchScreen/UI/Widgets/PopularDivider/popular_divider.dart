...
class PopularDivider extends StatefulWidget {
  const PopularDivider({super.key});

  @override
  _PopularDividerState createState() => _PopularDividerState();
}

class _PopularDividerState extends State<PopularDivider> {
  @override
