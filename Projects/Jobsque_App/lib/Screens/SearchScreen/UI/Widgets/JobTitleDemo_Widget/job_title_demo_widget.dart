        ...
        return widget.controller.isSuccessJobsData
            ? Text(
                widget.controller.isSuccessJobsFilter
                    ? widget.controller.jobsFilterData![widget.jobIndex!].name!
                    : widget.controller.jobsModel!.data![widget.jobIndex!].name!,
                textAlign: TextAlign.start,
                softWrap: true,
                style: TextStyle(
                  color: const Color(0xff111827),
                  fontSize: widget.controller.isSuccessJobsFilter
                      ? widget.controller.jobsFilterData![widget.jobIndex!].name!.length <= 15
                          ? MediaQuery_Size_Helper.MAX_WIDTH(context)! / 20.sp
                          : MediaQuery_Size_Helper.MAX_WIDTH(context)! / 22.0.sp
                      : widget.controller.jobsModel!.data![widget.jobIndex!].name!.length <= 15
                          ? MediaQuery_Size_Helper.MAX_WIDTH(context)! / 20.sp
                          : MediaQuery_Size_Helper.MAX_WIDTH(context)! / 22.0.sp,
