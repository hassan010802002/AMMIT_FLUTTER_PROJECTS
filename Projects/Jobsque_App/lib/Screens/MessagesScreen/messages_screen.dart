...
class MessagesScreen extends StatefulWidget {
  int? baseIndex;
  final MessagesControllerCubit messagesControllerCubit = MessagesControllerCubit();
...
class _MessagesScreenState extends State<MessagesScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context) => widget.messagesControllerCubit),
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: MessagesMainView(messagesControllerCubit: widget.messagesControllerCubit),
        ),
      ),
    );
  }
