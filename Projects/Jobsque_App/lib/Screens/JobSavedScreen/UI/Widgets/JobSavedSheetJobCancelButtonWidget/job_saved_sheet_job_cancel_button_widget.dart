...
class JobSavedSheetJobCancelButtonWidget extends StatefulWidget {
  const JobSavedSheetJobCancelButtonWidget({super.key});

  @override
  _JobSavedSheetJobCancelButtonWidgetState createState() => _JobSavedSheetJobCancelButtonWidgetState();
}

class _JobSavedSheetJobCancelButtonWidgetState extends State<JobSavedSheetJobCancelButtonWidget> {
  @override
