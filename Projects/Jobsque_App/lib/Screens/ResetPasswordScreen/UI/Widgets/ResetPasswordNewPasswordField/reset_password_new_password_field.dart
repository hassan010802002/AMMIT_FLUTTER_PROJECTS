...
class ResetPasswordNewPasswordField extends StatefulWidget {
  ...
  const ResetPasswordNewPasswordField({super.key, required this.resetPasswordControllerBloc});
    ...
    return BlocBuilder<ResetPasswordControllerBloc, ResetPasswordControllerState>(
      ...
      builder: (context, state) {
        return CustomTextField(
          ...
          opsecure: true,
          textEditingController: widget.resetPasswordControllerBloc.newPasswordController,
