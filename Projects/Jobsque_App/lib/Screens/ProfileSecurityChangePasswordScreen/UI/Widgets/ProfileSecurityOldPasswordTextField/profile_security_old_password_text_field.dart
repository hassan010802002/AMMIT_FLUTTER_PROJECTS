        ...
        return CustomTextField(
          ...
          focusedBorder: OutlineInputBorder(
            borderSide: BorderSide(
              ...
              color: widget.profileSecurityChangePasswordControllerBloc.isCorrectUserOldPassword
          ...
          onChanged: (oldPassword) {
            widget.profileSecurityChangePasswordControllerBloc.CheckingUserOldPassword(oldPassword);
          },
        );
      },
    );
