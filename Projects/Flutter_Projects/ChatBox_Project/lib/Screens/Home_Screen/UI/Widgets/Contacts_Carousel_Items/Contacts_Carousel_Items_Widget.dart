...
class Contacts_Carousel_Items_Widget extends StatefulWidget {
  ...
  Contacts_Carousel_Items_Widget({super.key, required this.homeController, required this.index});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          widget.homeController!.myContacts!.value.elementAt(widget.index!).avatar!.isEmpty
              ? Icon(
