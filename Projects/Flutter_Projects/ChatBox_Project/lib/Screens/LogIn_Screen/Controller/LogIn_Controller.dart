...
class LogIn_Controller extends GetxController {
  ...
  void customAuthentication(BuildContext context, String? message , {String? errorMessage}) async {
    try {
      final UserCredential currentUserCredential =
          await Main_Authentication_Service.customAuth(emailController.value.text, passwordController.value.text);
