...
class SignUpConsts {
  ...
  static const text3 = "كلمة المرور";
  static const text4 = "البريد الالكتروني";
  static const textFieldStyle1 = TextStyle(
      color: Colors.black, fontSize: 20.0, fontWeight: FontWeight.w800);
  static const text5 = "رقم الهاتف";
  static const text6 = "انثي";
  static const text7 = "ذكر";
  static const text8 = "تاكيد كلمة المرور";
  static const text9 = "موافق علي الشروط و الاحكام";
  static const text10 = "تسجيل";
  ...
  static const text10Style = TextStyle(
      ...
      fontSize: 32.0,
      fontFamily: "Tajawal");
  static const text11 = "تسجيل دخول";
  static const text12 = "لديك حساب؟ ";
  static const text11Style = TextStyle(
      color: Color(0xff0B3FA8),
      fontSize: 20.0,
      fontWeight: FontWeight.w800,
      fontFamily: "Tajawal");
  static const text12Style = TextStyle(
      color: Colors.black,
      fontSize: 16.0,
      fontWeight: FontWeight.w800,
      fontFamily: "Tajawal");
