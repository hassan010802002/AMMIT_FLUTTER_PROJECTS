...
class Car_Bookings_Consts {
  ...
  static const text1 = "الحجوزات";
  static const text2 = "نوع المركبة :";
  static const text3 = "موديل المركبة : " + " 2021 auto";
  static const text4 = "لون المركبة : ";
  static const text5 = "ص 09:00";
  static const text6 = "20 - 8 - 2021";
  static const text7 = "عفوا لا يوجد حجوزات حالية";
  static const popUpText1 = "التفاصيل";
  ...
  static const popUpText5Style = TextStyle(
      ...
      fontWeight: FontWeight.w800,
      fontFamily: "Tajawal");
  static const tab1Text = "السابقة";
  static const tab2Text = "الحالية";
  ...
  static const text7Style = TextStyle(
      ...
      fontSize: 20,
      fontFamily: "Tajawal");
  static var caruselContainerDecoration1 = BoxDecoration(
    borderRadius: BorderRadius.circular(15.0),
    color: Colors.white,
    boxShadow: [
      BoxShadow(
        color: Color.fromRGBO(197, 212, 245, 0.42),
        offset: Offset(0, 4),
        blurRadius: 20.0,
  ...
  static const defaultTabControllerAnimationDuration =
      Duration(milliseconds: 200);
  static const tabBarIndicatorPadding =
      EdgeInsets.only(left: 20.0, right: 20.0);
  static const mainColor = Color(0xff0B3FA8);
  static const closeButtonBackgroundColor = Color(0xffE91919);
  ...
  static var gridViewBuildContainerDecoration = BoxDecoration(
    color: Colors.white,
    borderRadius: BorderRadius.circular(15.0),
    boxShadow: [
      BoxShadow(
        color: Color.fromRGBO(197, 212, 245, 0.45),
        offset: Offset(0, 4),
        blurRadius: 10,
        spreadRadius: 5,
      )
  ...
  static const mainTextStyle = TextStyle(
      ...
      fontSize: 15.0,
      fontFamily: "Tajawal");
  static final circleAvatarBackGroundImage = AssetImage(
    "assets/Images/forbidden 1.png",
  );
}
