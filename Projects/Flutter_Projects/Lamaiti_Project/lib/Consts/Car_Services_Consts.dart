...
class Car_Services_Consts {
  ...
  static const text1 = "خدمات السيارة";
  static const text2 = "التاريخ";
  static const text3 = "الساعة";
  static const text4 = "خدمات رئيسية";
  static const text5 = "خدمات اضافية";
  static const text6 = "90 ر س";
  static const text7 = "المبلغ الاجمالي";
  static const text8 = "اضافة ملاحظات";
  static const text9 = "50 ر س";
  static const text10 = "غسيل عام";
  static const text11 = "10 ر س";
  static const text12 = "فواحة عطرية";
  static const text13 = "استمرار";
  static final radio2Value = "Perfeium Spray";
  static final radio1Value = "Normal Washing";
  ...
  static const text9Style = TextStyle(
    color: Color(0xff0B3FA8),
    fontFamily: "Tajawal",
    fontSize: 26.0,
    fontWeight: FontWeight.w800,
  ...
  static const text8Style = TextStyle(
    color: Color(0xffE91919),
    fontFamily: "Tajawal",
    fontSize: 16.0,
